                ...
                <div class="col-md-6 col-6">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Khalti</h6>
                      <span class="text-xs">Order's Payment</span>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-md-0 mb-4">
                      <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                        <img class="w-10 me-3 mb-0" src="{% static 'img/logos/mastercard.png' %}" alt="logo">
                    ...
                    <div class="col-md-6">
                      <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                        <img class="w-10 me-3 mb-0" src="{% static 'img/logos/visa.png' %}" alt="logo">
              ...
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    ...
                    <span class="mb-2 text-xs">Customer Name: <span class="text-dark font-weight-bold ms-sm-2">Viking Burrito</span></span>
                    <span class="mb-2 text-xs">Email Address: <span class="text-dark ms-sm-2 font-weight-bold">oliver@burrito.com</span></span>
                    <span class="text-xs">Order Number: <span class="text-dark ms-sm-2 font-weight-bold">FRB1235476</span></span>
                  </div>
                ...
                <li class="list-group-item border-0 d-flex p-4 mb-2 mt-3 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    ...
                    <span class="mb-2 text-xs">Customer Name: <span class="text-dark font-weight-bold ms-sm-2">Stone Tech Zone</span></span>
                ...
                <li class="list-group-item border-0 d-flex p-4 mb-2 mt-3 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    ...
                    <span class="mb-2 text-xs">Customer Name: <span class="text-dark font-weight-bold ms-sm-2">Fiber Notion</span></span>
